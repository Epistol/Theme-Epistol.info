...
if (function_exists('add_theme_support'))
{
	...
	add_image_size( 'wordpress-thumbnail', 120, 120, array( 'center', 'center' )  );
    add_image_size( 'index-thumb',885 , 220, true );
...
function html5blank_nav()
{
	...
	array(
		...
		'link_before'     => '',
		'link_after'      => '',
		'items_wrap'      => '<ul class="item_menu_top transition">%3$s</ul>',
		'depth'           => 0,
		'walker'          => ''
		)
	);
...
function nav_folio()
{
	...
	array(
		...
		'link_before'     => '',
		'link_after'      => '',
		'items_wrap'      => '<ul class="item_menu_top">%3$s</ul>',
		'depth'           => 0,
		'walker'          => ''
		)
	);
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        ...
        'before_title' => '<h3 class="titremenugauche transition">',
        'after_title' => '</h3><div class=" widget_menu_gauche">'
    ));
